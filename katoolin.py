...
def main():
 ...
 $$ |$$  /  $$$$$$\  $$$$$$\    $$$$$$\   $$$$$$\  $$ |$$\ $$$$$$$\ \a
 $$$$$  /   \____$$\ \_$$  _|  $$  __$$\ $$  __$$\ $$ |$$ |$$  __$$\ \a
 $$  $$<    $$$$$$$ |  \033[1;36mparrot os tools installer \033[1;m |$$ |$$ |$$ |  $$ | \a
 \033[1;36m$$ |\$$\  $$  __$$ |  $$ |$$\ $$ |  $$ |$$ |  $$ |$$ |$$ |$$ |  $$ | \a
 $$ | \$$\ \$$$$$$$ |  \$$$$  |\$$$$$$  |\$$$$$$  |$$ |$$ |$$ |  $$ | \a
 \__|  \__| \_______|   \____/  \______/  \______/ \__|\__|\__|  \__| V1.1 \033[1;m \a


 \033[1;32m+ -- -- +=[ Author: LionSec/Princeofguilty | Homepage: www.lionsec.net\033[1;m
 \033[1;32m+ -- -- +=[ 331 Tools \033[1;m


\033[1;91m[W] Before updating your system , please remove all Parrot-os repositories to avoid any kind of problem .\033[1;m
		''')
		def inicio1():
			while True:
				print ('''
1) Add Parrot repositories & Update
2) View Categories
3) Help
			...
			''')
				...
				while opcion0 == "1":
					print ('''
1) Add Parrot linux repositories
2) Update
3) Remove all Parrot os repositories
4) View the contents of sources.list file

					''')
					repo = raw_input("\033[1;32mWhat do you want to do ?> \033[1;m")
					if repo == "1":
						cmd2 = os.system("echo '# Parrot linux repositories | Added by Katoolin\ndeb https://ftp.halifax.rwth-aachen.de/parrotsec/ parrot main contrib non-free'>> /etc/apt/sources.list")
					elif repo == "2":
						...
						fin.close()
						fout.close()
						print ("\033[1;31m\nAll Parrot linux repositories have been deleted !\n\033[1;m")
					elif repo == "back":
						inicio1()
					elif repo == "gohome":
						inicio1()
...
0) All
			 ...
			 ''')
						print ("\033[1;32mSelect a category or press (0) to install all parrot linux tools .\n\033[1;m")
...
0) Install all Vulnerability Analysis tools
						...
						''')
							...
							if opcion2 == "1":
								...
								cmd = os.system("apt-get install --allow-unauthenticated   bbqsql bed cisco-auditing-tool cisco-global-exploiter cisco-ocs cisco-torch copy-router-config doona dotdotpwn greenbone-security-assistant hexorbase jsql lynis nmap ohrwurm openvas-cli openvas-manager openvas-scanner oscanner powerfuzzer sfuzz sidguesser siparmyknife sqlmap sqlninja sqlsus thc-ipv6 tnscmd10g unix-privesc-check yersinia")
							else:
								print ("\033[1;31mSorry, that was an invalid command!\033[1;m")
...
0) Install all Wireless Attacks tools
						...
						''')
							...
							if opcion2 == "1":
								...
								cmd = os.system("apt-get install --allow-unauthenticated   aircrack-ng asleap bluelog blueranger bluesnarfer bully cowpatty crackle eapmd5pass fern-wifi-cracker ghost-phisher giskismet gqrx kalibrate-rtl killerbee kismet mdk3 mfcuk mfoc mfterm multimon-ng pixiewps reaver redfang spooftooph wifi-honey wifitap wifite")
							elif opcion2 == "back":
								inicio()
							elif opcion2 == "gohome":
								inicio1()
...
0) Install all Web Applications tools
						...
						''')
							...
							if opcion2 == "1":
								...
								cmd = os.system("apt-get install --allow-unauthenticated   apache-users arachni bbqsql blindelephant burpsuite cutycapt davtest deblaze dirb dirbuster fimap funkload grabber jboss-autopwn joomscan jsql maltego-teeth padbuster paros parsero plecost powerfuzzer proxystrike recon-ng skipfish sqlmap sqlninja sqlsus ua-tester uniscan vega webscarab websploit wfuzz wpscan xsser zaproxy")
							else:
								print ("\033[1;31mSorry, that was an invalid command!\033[1;m")
						while opcion1 == "5":
							print ('''
...
0) Install all Sniffing & Spoofing tools
						...
						''')
							...
							if opcion2 == "1":
								...
								cmd = os.system("apt-get install --allow-unauthenticated   burpsuite dnschef fiked hamster-sidejack hexinject iaxflood inviteflood ismtp mitmproxy ohrwurm protos-sip rebind responder rtpbreak rtpinsertsound rtpmixsound sctpscan siparmyknife sipp sipvicious sniffjoke sslsplit sslstrip thc-ipv6 voiphopper webscarab wifi-honey wireshark xspy yersinia zaproxy")
							else:
								print ("\033[1;31mSorry, that was an invalid command!\033[1;m")
...
0) Install all Maintaining Access tools
						...
						''')
							...
							if opcion2 == "1":
								...
								cmd = os.system("apt-get install --allow-unauthenticated   cryptcat cymothoa dbd dns2tcp http-tunnel httptunnel intersect nishang polenum powersploit pwnat ridenum sbd u3-pwn webshells weevely")
							else:
								print ("\033[1;31mSorry, that was an invalid command!\033[1;m")
						while opcion1 == "7":
							print ('''
...
0) Install all Reporting Tools
						...
						''')
							...
							if opcion2 == "1":
								...
								cmd = os.system("apt-get install --allow-unauthenticated   casefile cutycapt dos2unix dradis keepnote magictree metagoofil nipper-ng pipal")
							else:
								print ("\033[1;31mSorry, that was an invalid command!\033[1;m")
...
0) Install all Exploitation Tools
						...
						''')
							...
							if opcion2 == "1":
								...
								cmd = os.system("apt-get install --allow-unauthenticated   armitage backdoor-factory cisco-auditing-tool cisco-global-exploiter cisco-ocs cisco-torch crackle jboss-autopwn linux-exploit-suggester maltego-teeth set shellnoob sqlmap thc-ipv6 yersinia beef-xss")
							else:
								print ("\033[1;31mSorry, that was an invalid command!\033[1;m")
...
0) Install all Forensics Tools
						...
						''')
							...
							if opcion2 == "1":
								...
								cmd = os.system("apt-get install --allow-unauthenticated   binwalk bulk-extractor chntpw cuckoo dc3dd ddrescue dumpzilla extundelete foremost galleta guymager iphone-backup-analyzer p0f pdf-parser pdfid pdgmail peepdf volatility xplico")
							else:
								print ("\033[1;31mSorry, that was an invalid command!\033[1;m")
						while opcion1 == "10":
							print ('''
...
0) Install all Stress Testing tools
						...
						''')
							...
							if opcion2 == "1":
								...
								cmd = os.system("apt-get install --allow-unauthenticated   dhcpig funkload iaxflood inviteflood ipv6-toolkit mdk3 reaver rtpflood slowhttptest t50 termineter thc-ipv6 thc-ssl-dos")
							else:
								print ("\033[1;31mSorry, that was an invalid command!\033[1;m")
						while opcion1 == "11":
							print ('''
...
0) Install all Password Attacks tools
						...
						''')
							...
							if opcion2 == "1":
								...
								cmd = os.system("apt-get install --allow-unauthenticated   acccheck burpsuite cewl chntpw cisco-auditing-tool cmospwd creddump crunch findmyhash gpp-decrypt hash-identifier hexorbase john johnny keimpx maltego-teeth maskprocessor multiforcer ncrack oclgausscrack pack patator polenum rainbowcrack rcracki-mt rsmangler statsprocessor thc-pptp-bruter truecrack webscarab wordlists zaproxy")
							else:
								print ("\033[1;31mSorry, that was an invalid command!\033[1;m")
						while opcion1 == "12" :
							print ('''
...
0) Install all Reverse Engineering tools
						...
						''')
							...
							if opcion2 == "1":
								...
								cmd = os.system("apt-get install --allow-unauthenticated   apktool dex2jar python-diStorm3 edb-debugger jad javasnoop OllyDbg smali Valgrind YARA")
							else:
								print ("\033[1;31mSorry, that was an invalid command!\033[1;m")
						while opcion1 == "13" :
							print ('''
...
0) Install all Hardware Hacking tools
						...
						''')
							...
							if opcion2 == "1":
								...
								cmd = os.system("apt-get install --allow-unauthenticated   android-sdk apktool arduino dex2jar sakis3g smali")
							else:
								print ("\033[1;31mSorry, that was an invalid command!\033[1;m")
						while opcion1 == "14" :
							print ('''
